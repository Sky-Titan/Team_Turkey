...
public class BookingListViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.bookinglist_item, parent, false);
        }
        ...
        TextView applicant = (TextView) convertView.findViewById(R.id.applicant) ;
        ...
        professor.setText(listViewItem.getProfessor());
        total.setText(listViewItem.getTotal());
        applicant.setText(listViewItem.getApplicant());
    ...
    public void addItem(String number, String title,String professor,String total,String applicant) {
