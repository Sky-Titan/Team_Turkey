...
public class CommentViewAdapter extends BaseAdapter {
    private ArrayList<CommentViewItem> listViewItemList = new ArrayList<CommentViewItem>() ;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        CommentViewItem listViewItem = listViewItemList.get(position);
    ...
    public void addItem(String id, String post_id,String content,String password) {
        CommentViewItem item = new CommentViewItem();
